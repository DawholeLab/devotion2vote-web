...
- `index.html` — página pública del producto con la identidad Devotion2Vote (logo crema · tinta · coral; Bodoni Moda + Montserrat).
- `assets/` — `logo.png` (logotipo completo, fondo transparente), `monograma.png` (D∆V para cabeceras y tamaños pequeños), `favicon.png`.
