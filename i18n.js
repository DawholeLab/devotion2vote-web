...
/* ---------- Mi campaña · portal, segmentación y fuentes (12-sep) ---------- */
"Elija el país de su campaña.":"Choose your campaign's country.",
"Cliente multinacional":"Multinational client",
"varios países en una misma sesión":"several countries in one session",
"Idioma / Language":"Idioma / Language",
"← Elegir otro país":"← Choose another country",
"Segmentación":"Segmentation",
"Fuentes de datos":"Data sources",
"Fuentes":"Sources",
"Cambiar país":"Change country",
"Clima de opinión de cada encuesta, sobre el total de entrevistados.":"Public mood in each survey, over all respondents.",
"Elija qué serie ver y recorra las tomas con las flechas, el reproductor o el deslizador.":"Choose which series to see and move through the waves with the arrows, the player or the slider.",
"Cada punto es una encuesta nacional de 1.500 entrevistas.":"Each point is a national survey of 1,500 interviews.",
"Toque una línea o un nombre para resaltarla.":"Tap a line or a name to highlight it.",
"Economía del país":"Country's economy",
"Lo que votó cada elector en la elección anterior (izquierda) y por quién votaría hoy (derecha), ajustado a los resultados oficiales. El grosor es el número de electores. Toque un nombre para seguir su voto. Hay cuadro en cada encuesta que preguntó el voto anterior.":"What each voter chose in the previous election (left) and who they would vote for today (right), adjusted to the official results. Thickness is the number of voters. Tap a name to follow its vote. There is a table for every survey that asked about the previous vote.",
"Las demarcaciones de la encuesta. Respuesta declarada, sin ajustar; las zonas con pocas entrevistas se indican y deben leerse con cautela.":"The survey's territorial units. Stated answer, unadjusted; areas with few interviews are flagged and should be read with caution.",
"Las figuras del partido y de sus rivales: a quién prefieren los entrevistados, cómo valoran a cada una y, para la mejor situada, sus públicos.":"The party's figures and their rivals: whom respondents prefer, how they rate each one and, for the best placed, their publics.",
"evolución":"trend",
"Públicos y segmentos":"Publics and segments",
"Los cuatro públicos del candidato, sus subsegmentos y los perfiles ahora viven en la pantalla":"The candidate's four publics, their sub-segments and the profiles now live in the screen",
", generada y aprobada en la Sala de Control.":", generated and approved in the Control Room.",
"Ir a Segmentación":"Go to Segmentation",
"Cuatro niveles, del más ancho al más fino: segmentos (los públicos del candidato), subsegmentos (grupos dentro de cada público), microsegmentos (por territorio) y nanosegmentos (por colegio electoral). Cada nivel se genera en el motor y solo aparece aquí cuando la Sala de Control lo ha aprobado.":"Four levels, from the broadest to the finest: segments (the candidate's publics), sub-segments (groups within each public), micro-segments (by territory) and nano-segments (by polling station). Each level is generated in the engine and only appears here once the Control Room has approved it.",
"La Sala de Control todavía no ha aprobado la segmentación de esta campaña. En cuanto lo haga, aparece aquí.":"The Control Room has not yet approved this campaign's segmentation. As soon as it does, it appears here.",
"Candidato ·":"Candidate ·",
"Subsegmentos":"Sub-segments",
"Micro":"Micro","Nano":"Nano",
"Serie completa":"Full series",
"Resultados oficiales por municipio":"Official results by municipality",
"Todo lo que sostiene las cifras de esta sala: cada encuesta con su índice de preguntas, los resultados oficiales que anclan las estimaciones y los registros territoriales. Nada se muestra aquí que no esté cargado en el motor y aprobado en la Sala de Control.":"Everything behind the figures in this room: each survey with its question index, the official results that anchor the estimates and the territorial records. Nothing is shown here that is not loaded in the engine and approved in the Control Room.",
"Encuestas":"Surveys",
"Buscar por mes, título o pregunta…":"Search by month, title or question…",
"Buscar encuesta":"Search survey",
"Resultados oficiales":"Official results",
"Las urnas con las que el método ancla cada estimación. Cada encuesta usa la elección anterior a su fecha de campo.":"The ballots the method anchors each estimate to. Each survey uses the election prior to its fieldwork date.",
"Registros territoriales":"Territorial records",
"Resultados oficiales por demarcación cargados en el motor; son la base de los niveles finos de segmentación.":"Official results by territorial unit loaded in the engine; they are the basis for the fine levels of segmentation.",
"Documentos":"Documents",
"Las fuentes de datos se listan cuando la sala se vuelva a publicar desde la Sala de Control.":"Data sources are listed once the room is published again from the Control Room.",
"{0} entrevistas":"{0} interviews",
"{0} preguntas":"{0} questions",
"{0} encuestas nacionales":"{0} national surveys",
